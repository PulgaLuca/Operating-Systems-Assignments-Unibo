...
{ 
	...
	while(1) {
		int indiceforchetta1=indice%NUMFILOSOFI;
		int indiceforchetta2=(indice+1)%NUMFILOSOFI;
		...
		/* AGGIUNGERE CODICE */
		DBGpthread_mutex_lock(mutexForchetta[indiceforchetta1]);
		DBGpthread_mutex_lock(mutexForchetta[indiceforchetta2]);
		...
		/* AGGIUNGERE CODICE */
		DBGpthread_mutex_unlock(mutexForchetta[indiceforchetta2]);
		DBGpthread_mutex_unlock(mutexForchetta[indiceforchetta1]);
		/* FINE AGGIUNTA CODICE */
